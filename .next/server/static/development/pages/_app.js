...
/* harmony import */ var _src_store__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../src/store */ "./src/store/index.ts");
...
/* harmony default export */ __webpack_exports__["default"] = (next_redux_wrapper__WEBPACK_IMPORTED_MODULE_5___default()(_src_store__WEBPACK_IMPORTED_MODULE_6__["initReduxStore"])(MyApp));
...
const initReduxStore = initialState => {
  ...
  if (isClient) {
    ...
    const storage = __webpack_require__(/*! redux-persist/lib/storage */ "redux-persist/lib/storage").default; // Mark some reducer as persisted on client


    const rootReducerClient = Object(redux__WEBPACK_IMPORTED_MODULE_0__["combineReducers"])({
      auth: persistReducer({
        key: "auth",
        storage
